...
df <- read.csv("Completed_Location_CSVs/df_Cairns_completed.csv",sep=",",stringsAsFactors = T)
...
fviz_screeplot(res.mfa,addlabels = TRUE, title = "Scree plot Cairns")
#dev.off()
...
fviz_mfa_var(res.mfa, "group", title ="Variable groups MFA - Cairns")
#dev.off()
...
fviz_contrib(res.mfa, "group", axes = 1, title = "Contribution of groups to Dim1 - Cairns")
#dev.off()
# Contribution to the second dimension
#png(paste(saveimages,"ContribGroupsDim2.png",sep=""),width = 600, height = 350)
fviz_contrib(res.mfa, "group", axes = 2, title = "Contribution of groups to Dim2 - Cairns")
#dev.off()
...
fviz_mfa_var(res.mfa, "quanti.var", palette = "jco", 
             col.var.sup = "violet", repel = TRUE, title = "Quantitative Variables MFA - Cairns")
#dev.off()
```
...
fviz_contrib(res.mfa, choice = "quanti.var", axes = 1, top = 20,
             palette = "jco", title = "Contribution of quantitative variables to Dim1 - Cairns")
#dev.off()
...
fviz_contrib(res.mfa, choice = "quanti.var", axes = 2, top = 20,
             palette = "jco", title = "Contribution of quantitative variables to Dim2 - Cairns")
#dev.off()
```
...
fviz_mfa_var(res.mfa, "quanti.var", col.var = "contrib", 
             ...
             geom = c("point", "text"), title = "Contribution Quantitative Variables MFA - Cairns")
#dev.off()
...
fviz_mfa_var(res.mfa, col.var = "cos2",
             gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"), 
             col.var.sup = "violet", repel = TRUE, title = "Cos2 Quantitative Variables MFA - Cairns")
#dev.off()
...
fviz_mfa_var(res.mfa, "quali.var", col.var = "contrib", 
             gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"), 
             col.var.sup = "violet", repel = TRUE,
             geom = c("point", "text"), title = "Qualitative variables categories MFA - Cairns")
#dev.off()
```
...
fviz_mfa_ind(res.mfa, 
             ...
             repel = TRUE, invisible = "quali.var", geom = "point", title = "Individuals MFA - Cairns")
#dev.off()

#####
#png(paste(saveimages,"IndsRainComparison.png",sep=""),width = 600, height = 350)
fviz_ellipses(res.mfa, c("RainTomorrow", "RainToday"), repel = TRUE, geom = "point", title = "MFA Factor map - Cairns")
#dev.off()
...
fviz_mfa_ind(res.mfa, 
             ...
             addEllipses = TRUE, ellipse.type = "confidence", 
             repel = TRUE, 
             invisible = "quali.var", geom = "point", title = "Individuals by Season MFA - Cairns")
#dev.off()
```
...
aes(x=x,y=y,col=Season,alpha=RainTomorrow, )) + ggtitle("Individuals MFA - Cairns") + geom_point() + theme_bw() +
