...
```{r}
names(Ptrain)
datos_tidy <- melt(Ptrain, id.vars = c("Date","RainTomorrow"), measure.vars = c( "Evaporation", "Sunshine", "WindGustSpeed", "WindSpeed9am", "WindSpeed3pm", 
...
df_num <- cbind(Ptrain[,"RainTomorrow"],df_num)
...
confusionMatrix(predictions$classBin, test.transformed$RainTomorrow, positive = "Yes")
```
