...
df <- read.csv("Location CSVs/df_Brisbane.csv",sep=",",stringsAsFactors = T)
df <- subset(df, Location == "Brisbane")
...
```{r}
#Getting MaxTemp
missing_MaxTemp <- read.csv("CSVs_for_gap_imputation/Brisbane_MaxTemp.csv",sep=",",stringsAsFactors = T)
...
#Getting MinTemp
missing_MinTemp <- read.csv("CSVs_for_gap_imputation/Brisbane_MinTemp.csv",sep=",",stringsAsFactors = T)
...
#Getting rainfall
missing_Rainfall <- read.csv("CSVs_for_gap_imputation/Brisbane_Rainfall.csv",sep=",",stringsAsFactors = T)
...
```{r}
write.csv(df6,'Completed_Location_CSVs/df_Brisbane_completed.csv', row.names = FALSE)
```
