...
colorData <- color.plot(sumTemp, quan=1/2, alpha=0.025, sub='Autumn MaxTemp vs Evaporation')

winTemp <- winter[,c("MaxTemp","Evaporation")]
colorData <- color.plot(winTemp, quan=1/2, alpha=0.025, sub='Autumn MaxTemp vs Evaporation')
```
...
colorData <- color.plot(autHum, quan=1/2, alpha=0.025, sub='Summer Humidity9am vs Humidity3pm')

sprHum <- spring[,c("Humidity9am","Humidity3pm")]
colorData <- color.plot(sprHum, quan=1/2, alpha=0.025, sub='Summer Humidity9am vs Humidity3pm')
...
colorData <- color.plot(winHum, quan=1/2, alpha=0.025, sub='Summer Humidity9am vs Humidity3pm')
