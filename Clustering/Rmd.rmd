...
author: Andrea Iglesias Munilla, Kathryn Weissman, Diana Galindo Gonzalez, Mateo Jacome
  Gonzalez y Pedro Gonzalez Prado - Clustering
output:
  html_document:
...
# Required packages
pkgs<-c("cluster","colorspace","dplyr","factoextra","fpc","ggplot2","ggpubr","NbClust","patchwork","reshape2","stats","summarytools","tidyr","tidyverse","rstudioapi")
...
funKm<- function(i){ tmp_df = listall[[i]];
                     ...
                     tmp_df[,ncol(tmp_df) + 1] = tmp_kmeans$cluster
                     colnames(tmp_df)[ncol(tmp_df)] = "KmeansCluster"
                     return(tmp_df)}  
